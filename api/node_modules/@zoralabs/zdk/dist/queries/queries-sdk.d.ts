...
export declare type ActiveMarketProperties = LilNounsAuction | NounsAuction | V2Auction | V3ReserveAuction;
...
export declare type EventProperties = ApprovalEvent | LilNounsAuctionEvent | MintEvent | NounsAuctionEvent | Sale | SeaportEvent | TransferEvent | V1MarketEvent | V2AuctionEvent | V3AskEvent | V3ReserveAuctionEvent;
...
export declare type MarketProperties = LilNounsAuction | NounsAuction | V1Ask | V1BidShare | V1Offer | V2Auction | V3Ask | V3ReserveAuction;
...
export declare type NounsDaoWithEvents = {
    __typename?: 'NounsDaoWithEvents';
    events: Array<NounsEvent>;
    nounsDao: NounsDao;
};
export declare type NounsDaoWithEventsConnection = {
...
export declare type NounsEventProperties = NounsBuilderAuctionEvent | NounsBuilderGovernorEvent | NounsBuilderManagerEvent;
...
export declare type RootQueryNounsArgs = {
    networks?: InputMaybe<Array<NetworkInput>>;
    pagination?: InputMaybe<PaginationInput>;
...
export declare type V3AskEventProperties = V3AskCanceledEventProperties | V3AskCreatedEventProperties | V3AskFilledEventProperties | V3AskPriceUpdatedEventProperties | V3PrivateAskEventProperties;
